...
<text x="500" y="339" fill="{cyan}" font-size="17">CORE.STACK</text>
...
<text x="500" y="528" fill="{muted}" font-size="12">CORE.INFRA</text><text x="680" y="528" fill="{main}" font-size="14">GitHub · Vercel</text></g></svg>'''
